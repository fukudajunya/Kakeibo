...
urlpatterns = [
    ...
    path('create_done/', views.KakeiboCreateView.create_done, name='create_done'),
    path('update/<int:pk>/', views.KakeiboUpdateView.as_view(), name='kakeibo_update'),
    path('update_done/', views.KakeiboUpdateView.update_done, name='update_done'),
    path('delete/<int:pk>/', views.KakeiboDeleteView.as_view(), name='kakeibo_delete'),
    path('delete_done/', views.KakeiboDeleteView.delete_done, name='delete_done'),
